...
/*=============================================  CARGAR SELECT  =============================================*/
 ...
 /*========================= CARGAR Id cobro de matricula =============================================*/
  static public function mdlSelectidcrobo($tabla)
  {
    $stmt = ConexionBD::Abrir_Conexion()->prepare("SELECT * FROM $tabla ");
...
/*========================= CARGAR Id Precio =============================================*/
  static public function mdlSelectIdPrecio($tabla)
  {
    $stmt = ConexionBD::Abrir_Conexion()->prepare("SELECT * FROM $tabla ");
   // $stmt->bindParam(":idcobromatri", 	$datos["Id_cobro"], 		PDO::PARAM_STR);
  	$stmt -> execute();
  ...
  /*========================= CARGAR Id Precio =============================================*/
  static public function mdlSelectIdEstadoPago($tabla)
  {
    $stmt = ConexionBD::Abrir_Conexion()->prepare("SELECT * FROM $tabla ");
   // $stmt->bindParam(":idcobromatri", 	$datos["Id_cobro"], 		PDO::PARAM_STR);
  	$stmt -> execute();
  ...
  /*========================= CARGAR Id Precio =============================================*/
  static public function mdlSelectIdMatriculado($tabla)
  {
    $stmt = ConexionBD::Abrir_Conexion()->prepare("SELECT * FROM $tabla ");
   // $stmt->bindParam(":idcobromatri", 	$datos["Id_cobro"], 		PDO::PARAM_STR);
  	$stmt -> execute();
